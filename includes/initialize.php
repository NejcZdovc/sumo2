<?php
	...
	ini_set('error_log',__DIR__.DS.'..'.DS.'v2'.DS.'logs'.DS.'errorFront_'.str_replace(array("www.", ":"), "", $_SERVER['HTTP_HOST']).'.log');
	
	function data_log($data) {
		$file = __DIR__.DS.'..'.DS.'v2'.DS.'logs'.DS.'data_'.str_replace(array("www.", ":"), "", $_SERVER['HTTP_HOST']).'.log';
		$fh = fopen($file, 'a+');
