<?php 
	$query = $db->query("SELECT title,email,keywords,description,template,SEO,display_title,offline,front_lang FROM cms_global_settings WHERE domain='".$user->domain."'");
	$result = $db->get($query);
?>
