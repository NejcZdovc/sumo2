...
<input type="hidden" id="GA" value="<?php echo $globals->GA_enabled?>" />
<input type="hidden" id="WM" value="<?php echo $globals->WM_enabled?>" />
	<div class="">
    <table cellpadding="0" cellspacing="4" border="0" width="99%" >
    <tr style="margin-bottom:20px;">
        <td class="left_td" valign="top" style="width:50%; min-width:25%;">
            <div style="clear:both; margin-bottom:20px;">
                <div class="title_form_big" style="float:left;"><?php echo $lang->SETTINGS_29?></div>
			...
			?>
                ...
                <td style="background:#F3F3F3;vertical-align:middle; height:30px; padding:10px;">
                    <?php echo $template_f['name']?>
                </td>
                <td style="background:#F3F3F3;vertical-align:middle; padding:10px;" width="100px">
                    <div title="<?php echo $lang->MENU_7?>" class="<?php echo $template_f['enabled']?"enable":"disable"; ?> sumo2-tooltip" onclick="sumo2.sumoSettings.ChangeStatus('<?php echo $crypt->encrypt($template_f['ID']); ?>')"></div>
                    <div title="<?php echo $lang->MENU_14?>" class="add sumo2-tooltip" onclick="sumo2.sumoSettings.NewPageT('<?php echo $crypt->encrypt($template_f['ID']); ?>')"></div>
                    <div title="<?php echo $lang->MOD_107?>" class="edit sumo2-tooltip" onclick="sumo2.dialog.NewDialog('d_settings_edit_t','ID=<?php echo $crypt->encrypt($template_f['ID']); ?>')"></div>
                    <div title="<?php echo $lang->MOD_246?>" class="edit sumo2-tooltip" style="background-image: url(/v2/images/css_sprite.png);background-position: -604px -1629px;" onclick="sumo2.sumoSettings.ClearCacheT('<?php echo $crypt->encrypt($template_f['folder']); ?>')"></div>
                    <div title="<?php echo $lang->MOD_108?>" class="delete sumo2-tooltip" onclick="sumo2.sumoSettings.DeleteT('<?php echo $crypt->encrypt($template_f['ID']); ?>')"></div>
                </td>
                </tr>
            <?php } ?>
            </table>
        ...
        <td class="right_td" style="width:50%; vertical-align:top; min-width:25%;">
       		<div style="clear:both; margin-bottom:20px;">
                <div class="title_form_big" style="float:left;"><?php echo $lang->SETTINGS_35?></div>
            ...
            <td style="background:#E6ECF2;vertical-align:middle; height:30px; padding:10px;">
            	<?php echo $template_p['name']?>
            </td>
            <td style="background:#E6ECF2;vertical-align:middle; height:30px; padding:10px;">
            	<?php echo $template_p['prefix']?>
            </td>
            <td style="background:#E6ECF2;vertical-align:middle; height:30px; width:28px; padding-left:8px;">
            	<div title="<?php echo $lang->MOD_108?>" class="delete sumo2-tooltip" onclick="sumo2.sumoSettings.DeleteTP('<?php echo $crypt->encrypt($template_p['ID']); ?>')"></div>
            </td>
            </tr>
            <?php } ?>
            </table>
    ...
    <tr style="margin-bottom:20px;">
        <td class="right_td" valign="top" style="width:50%; vertical-align:top;">
            <div style="clear:both; margin-bottom:20px;">
                <div class="title_form_big" style="float:left;"><?php echo $lang->SETTINGS_36?></div>
            ...
            <td style="background:#E6ECF2;vertical-align:middle; height:30px; padding:10px;">
                <?php echo $template_f['short']?>
            </td>
            <td style="background:#E6ECF2;vertical-align:middle; padding:10px;" width="20px">
                <div title="<?php echo $lang->MENU_7?>" class="<?php echo $template_f['enabled']?"enable":"disable"; ?> sumo2-tooltip" onclick="sumo2.sumoSettings.ChangeStatusLb('<?php echo $crypt->encrypt($template_f['ID']); ?>')"></div>
            </td>
            </tr>
            <?php } ?>
            </table>
        ...
        <td class="left_td" valign="top" style="width:50%;">
            <div style="clear:both; margin-bottom:20px;">
                 <div class="title_form_big" style="float:left;"><?php echo $lang->SETTINGS_37?></div>
            ...
            <td style="background:#F3F3F3;vertical-align:middle; padding:10px;" width="20px">
                <div title="<?php echo $lang->MENU_7?>" class="<?php echo $template_f['enabled']?"enable":"disable"; ?> sumo2-tooltip" onclick="sumo2.sumoSettings.ChangeStatusLf('<?php echo $crypt->encrypt($template_f['ID']); ?>')"></div>
            </td>
            </tr>
            <?php } ?>
            </table>
        ...
        <tr style="margin-bottom:20px;">
        <td class="left_td" valign="top" style="width:50%;">
            <div class="title_form_big" style="float:left;"><?php echo $lang->SETTINGS_38?></div>
            <div style="margin-top:30px;">
                <div style="float:left;">Google Analytics</div>
                <div style="float:left;" title="<?php echo $lang->MENU_7?>" class="<?php echo $globals->GA_enabled?"enable":"disable"; ?> sumo2-tooltip" onclick="sumo2.sumoSettings.GAstat()"></div>
            </div>
            <div style="clear:both; padding-top:5px;">
            <div style="float:left; margin-top:10px; margin-right:5px;" class="title_form_small"><?php echo $lang->MOD_109?>:</div><input id="GA_ID" type="text" class="input" maxlength="50" style="float:left; width:150px; margin-right:20px;" value="<?php echo $globals->GA_ID?>"  />
            <select id="GA_type" disabled="disabled" class="input" style="float:left; width:197px; margin-top:7px;" >
                <option value="1" <?php if($globals->GA_type=="1") echo 'selected="Selected"';?>><?php echo $lang->MOD_110?></option>
                <option value="2" <?php if($globals->GA_type=="2") echo 'selected="Selected"';?>><?php echo $lang->MOD_112?></option>       
            </select>
            </div>
            ...
            <div style="padding-top:30px; clear:both;">
                ...
                <div style="float:left;" title="<?php echo $lang->MENU_7?>" class="<?php echo $globals->WM_enabled?"enable":"disable"; ?> sumo2-tooltip" onclick="sumo2.sumoSettings.WMstat()"></div>
            </div>
            <div style="clear:both; padding-top:5px;">
                <div style="float:left; margin-top:10px; margin-right:5px;" class="title_form_small"><?php echo $lang->MOD_113?>:</div><input id="WM_ID" type="text" class="input" maxlength="60" style="float:left; width:400px; margin-right:20px;" value="<?php echo $globals->WM_ID?>"  />
		...
		<td class="right_td" style="width:50%; vertical-align:top;">
       		<div style="clear:both; margin-bottom:20px;">
                <div class="title_form_big" style="float:left;"><?php echo $lang->SETTINGS_39?></div>
            ...
            <tr>
            <td style="background:#E6ECF2;vertical-align:middle; height:30px; padding:10px;">
            	<?php echo $modul_p['name']?>
            </td>
            <td style="background:#E6ECF2;vertical-align:middle; height:30px; padding:10px;">
            	<?php echo $modul_p['prefix']?>
            </td>
            <td style="background:#E6ECF2;vertical-align:middle; padding:10px;" width="40px">
            	<div title="<?php echo $lang->MENU_7?>" class="<?php echo $modul_p['enabled']?"enable":"disable"; ?> sumo2-tooltip" onclick="sumo2.sumoSettings.Status_prefix('<?php echo $crypt->encrypt($modul_p['ID']); ?>')"></div>
                <div title="<?php echo $lang->MOD_108?>" class="delete sumo2-tooltip" onclick="sumo2.sumoSettings.DeleteP('<?php echo $crypt->encrypt($modul_p['ID']); ?>')"></div>
            </td>
            </tr>
            <?php } ?>
            </table>
    ...
    <tr>
        <td class="right_td" style="width:50%; vertical-align:top;">
        	<div style="clear:both; margin-bottom:20px;">
                <div class="title_form_big" style="float:left;"><?php echo $lang->SETTINGS_40?></div>
        ...
        <td class="left_td" valign="top" style="width:50%;">
        <div style="clear:both; margin-bottom:20px;">
                <div class="title_form_big" style="float:left;"><?php echo $lang->MOD_123?></div>
                ...
                <table width="99%" cellpadding="0" cellspacing="0" border="0" style="clear:both;">
                    <tr>
                        <td width="150px"><?php echo $lang->MOD_124?>:</td>
                        <td><input type="password" class="input" name="FTP_user" style="width:250px;" value="000000000000" /></td>
                    </tr>
                	<tr>
                        <td><?php echo $lang->MOD_125?>:</td>
                        <td><input type="password" class="input" name="FTP_pass" style="width:250px;" value="000000000000" /></td>
                    </tr>
                    <tr>
                        <td><?php echo $lang->MOD_126?>:</td>
                        <td><input type="text" class="input" name="FTP_url" style="width:250px;" value="<?php echo $globals->FTP_url?>" /></td>
                    </tr>
                    <tr>
                        <td><?php echo $lang->MOD_127?>:</td>
                        <td><input type="text" class="input" name="FTP_port" style="width:50px;" value="<?php echo $globals->FTP_port?>" /></td>
                    </tr>
                </table>
            </div>
        </td>	
