...
<a href="/v2/logs/errorFront_<?php echo $fileName ?>.log" target="_blank" class="sumo2-tooltip view" style="float:right; margin:0px 10px 10px;" title="<?php echo $lang->MOD_55?>"></a>
<?php if($user->errorLog=="1") { ?>
<div class="sumo2-tooltip" style="float:right; margin-bottom:10px; cursor:pointer;" onclick="sumo2.sumoSettings.CleanLog('<?php echo "errorFront_".$fileName.".log"; ?>')" title="<?php echo $lang->SETTINGS_41?>"><div style="display:block;width:16px;height:16px;background-image:url(images/css_sprite.png);background-position:-604px -1629px;"></div></div>
<?php } ?>
