...
<tr>
        ...
        <td class="right_td">
	<input name="required" id="required" value="1" type="radio" /> <?php echo $lang->ARTICLE_19?>&nbsp;&nbsp;<input name="required" id="required" value="0" type="radio" /> <?php echo $lang->ARTICLE_20?>
        </td>
    </tr>
