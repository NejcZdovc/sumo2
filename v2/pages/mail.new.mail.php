...
<form action="" method="post" class="form2">
    ...
    <tr>
        ...
        <div class="title_form_big"><?php echo $lang->MAIL_NEW_S_1?>:</div><div class="title_form_small"><?php echo $lang->MAIL_NEW_S_2?></div>
        </td>
    ...
    <tr>
        ...
        <div class="title_form_big"><?php echo $lang->MAIL_NEW_C_1?>:</div><div class="title_form_small"><?php echo $lang->MAIL_NEW_C_2?></div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="left_td"  width="30%" valign="top">
        <div class="title_form_big"><?php echo $lang->MAIL_NEW_R_1?>:</div><div class="title_form_small"><?php echo $lang->MAIL_NEW_R_2?></div>
        </td>
        <td class="right_td" style="padding:10px;">
        <div style="float:left; margin-right:15px; cursor:pointer;"><a onclick="sumo2.mail.SelectAll(1);"><?php echo $lang->SELECT_ALL?></a></div> <div style="float:left; cursor:pointer;"><a onclick="sumo2.mail.SelectAll(2);"><?php echo $lang->MANUAL_SEL?></a></div><div style="clear:both; margin-bottom:10px;"></div>
