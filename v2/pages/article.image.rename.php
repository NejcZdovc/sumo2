...
?>
<div class="center-inputs"><div class="input-label"><?=$lang->MOD_31?>:</div>
<form action="" name="d_article_image_rename" method="post" class="form2">
<input type="text" name="rename" id="rename_article_image" class="input" value="<?=$results_basic['name']?>" />
<input type="hidden" name="id" value="<?=$db->filter('id')?>" id="image_id" />
