...
<form action="" name="a_article_new_a" method="post" class="form2">
	<div class="table_panel">
   	...
   	<tr>
        ...
        <div title="<?=$lang->ARTICLE_15?>" onclick="sumo2.dialog.NewDialog('d_article_cat', 'type=N$!$id=')" style="cursor:pointer; font-weight:bold; font-size:15px; margin-left:40%;"><?=$lang->MOD_45?></div>
        </td>
   	</tr>
   	<tr>
    <td class="left_td" colspan="5">
        <div style="float:left; margin-right:5px;"><span class="title_form_big"><?=$lang->ARTICLE_17?></span></div>
        <div style="clear:both;"></div>
        <div id="add_options_1"> 
        	<div style="float:left; margin-right:10px; width:155px;"><span style="font-size:13px;"><?=$lang->ARTICLE_6?>:</span><input type="text" readonly="readonly" id="date-start-a" style="margin-left:5px; cursor:pointer;" class="input" size="16" value=""/></div>
            <div style="float:left; margin-right:10px; width:155px;"><span style="font-size:13px;"><?=$lang->ARTICLE_7?>:</span> <input type="text" readonly="readonly" id="date-end-a" style="margin-left:5px; cursor:pointer;" size="16" class="input" value=""/></div>
            <div style="float:left; margin-right:10px; width:155px;"><span style="font-size:13px;"><?=$lang->ARTICLE_5?>:</span> <input type="text" id="author" class="input" style="margin-left:5px;" size="25" value="<?=$user->name?>"/></div>
            <div style="float:left; width:155px;"><span style="font-size:13px;"><?=$lang->ARTICLE_16?>:</span> <input class="input" type="text" id="alias" style="margin-left:5px;" size="25" value=""/></div>
        <div style="float:left; margin-left:20px;"><span style="font-size:13px; display:block; margin-bottom:6px;"><?=$lang->ARTICLE_18?>:</span><input type="radio" name="published" checked="checked" id="yes" value="1"><label for="yes"><?=$lang->ARTICLE_19?></label><input type="radio" name="published" id="no" value="0"><label for="no"><?=$lang->ARTICLE_20?></label></div>
        	<div style="clear:both;"></div>
        </div>
