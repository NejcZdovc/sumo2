...
<form action="" name="a_article_a_translate" method="post" class="form2">
	<input type="hidden" id="parent" value="<?php echo $id?>" />
    <input type="hidden" id="lang" value="<?php echo $language?>" />
	<div class="table_panel">
   	<table cellpadding="0" cellspacing="4" border="0" width="100%" >
   	<tr>
        <td class="left_td td_width" width="50%" valign="top">
        <div class="title_form_big"><?php echo $lang->ARTICLE_NEW_T_1?>:</div><div class="title_form_small" style="margin-bottom:10px; width:100%;"><?php echo $lang->ARTICLE_NEW_T_2?></div>
        <div style="float:left; width:45%;"><b><?php echo $short_old?> <?php echo $lang->ARTICLE_29?>:</b><br/><?php echo $old['title']?></div><div style="margin-left:10px; width:45%; float:left;"><b><?php echo lang_name_front($language)?> <?php echo $lang->ARTICLE_29?>:</b> <input name="title" id="title" value="" type="text" class="input" /></div>
        </td>
        <td class="left_td td_width" width="50%" valign="top">
        <div class="title_form_big"><?php echo $lang->ARTICLE_NEW_C_1?>:</div><div class="title_form_small" style="margin-bottom:10px;"><?php echo $lang->ARTICLE_14?></div>
        <div style="float:left; width:45%;"><b><?php echo $short_old?> <?php echo $lang->ARTICLE_29?>:</b><br/><?php echo $Cats?></div><div style="margin-left:10px; width:45%; float:left;"><b><?php echo lang_name_front($language)?> <?php echo $lang->ARTICLE_29?>:</b><input id="category_new_article_translate" value="" name="category" type="hidden" />
        <div title="<?php echo $lang->ARTICLE_15?>" onclick="sumo2.dialog.NewDialog('d_article_cat', 'type=T$!$id=')" style="cursor:pointer; font-weight:bold; font-size:15px; margin-left:40%;"><?php echo $lang->MOD_45?></div></div>
        </td>
   	</tr>
   	<tr>
        ...
        <div id="add_options_1"> 
            ...
            <div style="float:left;"><span style="font-size:13px;"><?php echo $lang->ARTICLE_16?>:</span> <input class="input" type="text" id="alias" style="margin-left:5px;" size="25" value=""/></div>
   	...
   	<tr>
        ...
        <div class="title_form_big"><?php echo $lang->ARTICLE_21?>:</div><div class="title_form_small"><?php echo $lang->ARTICLE_22?></div>
        </td>
   	</tr>
   	<tr>
    	<td colspan="2">
        <div style="width:90%; margin-left:5%; margin-bottom:10px; margin-right:5%;"><b><?php echo $short_old?> <?php echo $lang->ARTICLE_29?>:</b><br/><?php echo htmlspecialchars_decode($old['stub'])?></div><div style="width:90%; margin-left:5%; margin-right:5%;"><b><?php echo lang_name_front($language)?> <?php echo $lang->ARTICLE_29?>:</b><br/>
    ...
    <div id="old_html" style="display:none;"><?php echo  htmlspecialchars_decode($old['content'])?></div>
