...
?>
	<div class="flt-right display" style="cursor:pointer;"><span onclick="sumo2.trash.SelectAll('a_trash_menuI_check', '1');"><?=$lang->MOD_58?></span> / <span onclick="sumo2.trash.SelectAll('a_trash_menuI_check', '0');"><?=$lang->MOD_59?></span></div><div class="flt-right display" onclick="sumo2.trash.DeleteAll('a_trash_menuI_check', 'menuI');" style="cursor:pointer;"><?=$lang->FILE_3?></div>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table1 table2" id="viewgroups" width="99%">
        ...
        <?php 
            ...
            while($result = $db->fetch($query)) {			
                	...
                	<td width="30px;" style="text-align:center;"><img src="images/icons/flags/<?=lang_name_front($items_query['lang'])?>.png" alt="<?=lang_name_front($items_query['lang'])?>"/></td>
					<td><?php echo $result['title'];?></td>
					<td><div class="sumo2-tooltip" title="<?php echo $result['description']; ?>"><?php echo $description;?></div></td>
                    <td><?=$items_query['title']?></td>
                        <td width="65px">
