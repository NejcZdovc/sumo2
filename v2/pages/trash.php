	...
	<table border="0" cellpadding="0" cellspacing="0" style="vertical-align:top;" width="100%" height="100%">
    	<tr style="vertical-align:top;">
        	<td width="170px" style="vertical-align:top;">
                <ul class="tabs_trash" >
                    <li id="articletab"><a href="#article"><?=$lang->MOD_43?></a></li>
                    <li id="articleGtab"><a href="#articleG"><?=$lang->MOD_94?></a></li>
                    <li id="usertab"><a href="#user"><?=$lang->FAV_USER?></a></li>
                    <li id="userGtab"><a href="#userG"><?=$lang->MOD_93?></a></li>
                    <li id="menutab"><a href="#menu"><?=$lang->MOD_90?></a></li>
                    <li id="menuItab"><a href="#menuI"><?=$lang->MOD_95?></a></li>
                    <li id="mailtab"><a href="#mail"><?=$lang->MAIL?></a></li>
                    <li id="modulitab"><a href="#moduli"><?=$lang->FAV_MODULES?></a></li>
                    <li id="comtab"><a href="#com"><?=$lang->MOD_139?></a></li>
                    <li id="temptab"><a href="#temp"><?=$lang->SETTINGS_29?></a></li>                    
                </ul>
            </td>
