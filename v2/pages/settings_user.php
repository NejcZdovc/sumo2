...
<form action="" name="a_settings_user" method="post" class="form2">
    ...
    <tr>
        ...
        <td class="right_td">
        <input name="subject" id="name" class="input" value="<?= $result['name'];?>" type="text" maxlength="50" />
        </td>
    </tr>
    <tr>
        <td class="left_td" valign="top">
    ...
    <tr>
        <td class="left_td" valign="top">
		<div class="title_form_big"><?=$lang->USER_ADDU_P_8?>:</div><div class="title_form_small"><?=$lang->USER_ADDU_P_9?></div>
        </td>
        <td class="right_td">
    ...
    <tr>
        ...
        <div style="float: left"><div class="title_form_big"><?=$lang->USER_ADDU_P_5?>:</div><div class="title_form_small"><?=$lang->USER_ADDU_P_6?></div></div>
        <div class="flt-right password"><div><div id="password_indicator_a_settings_user"><div style="display:block;background-image:url(images/css_sprite.png);background-position:-1109px -1634px;width:230px;height:19px;"></div></div></div><div id="password_strength_a_settings_user" class="password-title"><?=$lang->USER_ADDU_P_7?></div></div>
        </td>
    </tr>
    <tr><td height="10px" width="100%" colspan="2"></td></tr>
     <tr>
