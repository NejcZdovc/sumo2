...
<form action="" name="a_article_edit_a" method="post" class="form2">
	<input id="id_a" name="id_a" type="hidden" value="<?php echo $db->filter('id')?>" />
    <input id="id_ad" name="id_ad" type="hidden" value="<?php echo $id?>" />
    ...
    <tr>
        ...
        <input name="title" id="title" value="<?php echo $results_basic['title']?>" type="text" class="input" />
        </td>
        <td class="left_td td_width" width="25%" valign="top">
        <div class="title_form_big"><?php echo $lang->ARTICLE_NEW_C_1?>:</div><div class="title_form_small"><?php echo $lang->MOD_46?></div>
        </td>
        <td class="right_td td_width" width="25%">
        <input id="category_edit_article" value="<?php echo $results_basic['category']?>" name="category" type="hidden" />
        <div id="cat_edit_new" title="<?php echo $lang->ARTICLE_15?>" onclick="" style="cursor:pointer; font-weight:bold; font-size:15px; margin-left:40%;"><?php echo $lang->MOD_45?></div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
   	...
   	<tr>
    	<td colspan="5">
    		<textarea  id="summery" style="width:85%; margin-left:5%; margin-right:5%; height:100px;" class="input-area"><?php echo htmlspecialchars_decode($results_basic['stub'])?></textarea>
            <textarea  id="keywords" style="width:85%; margin-left:5%; margin-right:5%; height:100px; display:none;" class="input-area"><?php echo htmlspecialchars_decode($results_basic['keywords'])?></textarea>
            <textarea  id="description" style="width:85%; margin-left:5%; margin-right:5%; height:100px; display:none;" class="input-area"><?php echo htmlspecialchars_decode($results_basic['description'])?></textarea>
        </td>
   	</tr>
   <tr>
   		<td colspan="5" class="left_td" valign="top">
    ...
    <tr>
		...
		<noscript>
			...
			<textarea class="ckeditor" id="testeditor" name="content" rows="10"><?php echo htmlspecialchars_decode($results_basic['content'])?></textarea>
        </td>
    </tr>
    <tr>
