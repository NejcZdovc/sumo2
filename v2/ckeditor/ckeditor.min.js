...
CKEDITOR.config.disableObjectResizing=!1;CKEDITOR.config.disableNativeTableHandles=!0;CKEDITOR.config.disableNativeSpellChecker=!0;CKEDITOR.config.contentsCss=CKEDITOR.getUrl("contents.css");(function(){CKEDITOR.plugins.add("iframe",{requires:"dialog,fakeobjects",onLoad:function(){CKEDITOR.addCss("img.cke_iframe{background-image: url("+CKEDITOR.getUrl(this.path+"images/placeholder.png")+");background-position: center center;background-repeat: no-repeat;border: 1px solid #a9a9a9;width: 80px;height: 80px;}")},init:function(a){var b=a.lang.iframe,c="iframe[align,longdesc,frameborder,height,name,scrolling,src,title,width]";a.plugins.dialogadvtab&&(c+=";iframe"+a.plugins.dialogadvtab.allowedContent({id:1,
...
c=CKEDITOR.tools.addFunction(e),c=k.replace("%1",c).replace("%2",CKEDITOR.tools.htmlEncode(a.src));b.setHtml(c)})}};e.prototype=new CKEDITOR.ui.dialog.uiElement;CKEDITOR.dialog.addUIElement("iframe",{build:function(d,a,j){return new e(d,a,j)}})})()}});CKEDITOR.config.plugins='dialogui,dialog,a11yhelp,basicstyles,blockquote,clipboard,button,panelbutton,panel,floatpanel,colorbutton,colordialog,menu,contextmenu,dialogadvtab,div,enterkey,entities,popup,filebrowser,find,fakeobjects,flash,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,image,indent,indentblock,indentlist,justify,link,list,liststyle,magicline,maximize,pastefromword,pastetext,removeformat,selectall,showblocks,showborders,sourcearea,specialchar,tab,table,tabletools,toolbar,undo,wysiwygarea,iframe,iframedialog';CKEDITOR.config.skin='moono';(function() {var setIcons = function(icons, strip) {var path = CKEDITOR.getUrl( 'plugins/' + strip );icons = icons.split( ',' );for ( var i = 0; i < icons.length; i++ )CKEDITOR.skin.icons[ icons[ i ] ] = { path: path, offset: -icons[ ++i ], bgsize : icons[ ++i ] };};if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,blockquote,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,bgcolor,312,,textcolor,336,,creatediv,360,,find-rtl,384,,find,408,,replace,432,,flash,456,,horizontalrule,480,,image,504,,indent-rtl,528,,indent,552,,outdent-rtl,576,,outdent,600,,justifyblock,624,,justifycenter,648,,justifyleft,672,,justifyright,696,,anchor-rtl,720,,anchor,744,,link,768,,unlink,792,,bulletedlist-rtl,816,,bulletedlist,840,,numberedlist-rtl,864,,numberedlist,888,,maximize,912,,pastefromword-rtl,936,,pastefromword,960,,pastetext-rtl,984,,pastetext,1008,,removeformat,1032,,selectall,1056,,showblocks-rtl,1080,,showblocks,1104,,source-rtl,1128,,source,1152,,specialchar,1176,,table,1200,,redo-rtl,1224,,redo,1248,,undo-rtl,1272,,undo,1296,,iframe,1320,','icons_hidpi.png');else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,blockquote,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,bgcolor,312,auto,textcolor,336,auto,creatediv,360,auto,find-rtl,384,auto,find,408,auto,replace,432,auto,flash,456,auto,horizontalrule,480,auto,image,504,auto,indent-rtl,528,auto,indent,552,auto,outdent-rtl,576,auto,outdent,600,auto,justifyblock,624,auto,justifycenter,648,auto,justifyleft,672,auto,justifyright,696,auto,anchor-rtl,720,auto,anchor,744,auto,link,768,auto,unlink,792,auto,bulletedlist-rtl,816,auto,bulletedlist,840,auto,numberedlist-rtl,864,auto,numberedlist,888,auto,maximize,912,auto,pastefromword-rtl,936,auto,pastefromword,960,auto,pastetext-rtl,984,auto,pastetext,1008,auto,removeformat,1032,auto,selectall,1056,auto,showblocks-rtl,1080,auto,showblocks,1104,auto,source-rtl,1128,auto,source,1152,auto,specialchar,1176,auto,table,1200,auto,redo-rtl,1224,auto,redo,1248,auto,undo-rtl,1272,auto,undo,1296,auto,iframe,1320,auto','icons.png');})();CKEDITOR.lang.languages={"de":1,"en":1,"hr":1,"it":1,"sl":1};}());