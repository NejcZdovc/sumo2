...
toolbar:"align,20"}),a.ui.addButton("JustifyRight",{label:a.lang.justify.right,command:"justifyright",toolbar:"align,30"}),a.ui.addButton("JustifyBlock",{label:a.lang.justify.block,command:"justifyblock",toolbar:"align,40"}));a.on("dirChanged",j)}}})})();(function(){function m(c){return c.replace(/'/g,"\\$&")}function n(c){for(var b,a=c.length,f=[],e=0;e<a;e++)b=c.charCodeAt(e),f.push(b);return"String.fromCharCode("+f.join(",")+")"}function o(c,b){var a=c.plugins.link,f=a.compiledProtectionFunction.params,e,d;d=[a.compiledProtectionFunction.name,"("];for(var g=0;g<f.length;g++)a=f[g].toLowerCase(),e=b[a],0<g&&d.push(","),d.push("'",e?m(encodeURIComponent(b[a])):"","'");d.push(")");return d.join("")}function l(c){var c=c.config.emailProtection||"",
...
return a}});var j=/^[\s\n\r]*$/}var k=!CKEDITOR.env.ie||8<CKEDITOR.env.version;CKEDITOR.plugins.add("codesnippet",{requires:"widget,dialog",beforeInit:function(a){a._.codesnippet={};this.setHighlighter=function(b){a._.codesnippet.highlighter=b;b=a._.codesnippet.langs=a.config.codeSnippet_languages||b.languages;a._.codesnippet.langsRegex=RegExp("(?:^|\\s)language-("+CKEDITOR.tools.objectKeys(b).join("|")+")(?:\\s|$)")}},onLoad:function(){CKEDITOR.dialog.add("codeSnippet",this.path+"dialogs/codesnippet.js")},
init:function(a){a.ui.addButton&&a.ui.addButton("CodeSnippet",{label:a.lang.codesnippet.button,command:"codeSnippet",toolbar:"insert,10"})},afterInit:function(a){var b=this.path;l(a);a._.codesnippet.highlighter||this.setHighlighter(new CKEDITOR.plugins.codesnippet.highlighter({languages:{apache:"Apache",bash:"Bash",coffeescript:"CoffeeScript",cpp:"C++",cs:"C#",css:"CSS",diff:"Diff",html:"HTML",http:"HTTP",ini:"INI",java:"Java",javascript:"JavaScript",json:"JSON",makefile:"Makefile",markdown:"Markdown",
nginx:"Nginx",objectivec:"Objective-C",perl:"Perl",php:"PHP",python:"Python",ruby:"Ruby",sql:"SQL",vbscript:"VBScript",xhtml:"XHTML",xml:"XML"},init:function(c){var j=this;k&&CKEDITOR.scriptLoader.load(b+"lib/highlight/highlight.pack.js",function(){j.hljs=window.hljs;c()});a.addContentsCss(b+"lib/highlight/styles/"+a.config.codeSnippet_theme+".css")},highlighter:function(a,b,d){(a=this.hljs.highlightAuto(a,this.hljs.getLanguage(b)?[b]:void 0))&&d(a.value)}}))}});CKEDITOR.plugins.codesnippet={highlighter:f};
f.prototype.highlight=function(){var a=arguments;this.ready?this.highlighter.apply(this,a):this.queue.push(function(){this.highlighter.apply(this,a)})}})();CKEDITOR.config.codeSnippet_codeClass="hljs";CKEDITOR.config.codeSnippet_theme="default";CKEDITOR.config.plugins='dialogui,dialog,a11yhelp,basicstyles,blockquote,clipboard,button,panelbutton,panel,floatpanel,colorbutton,colordialog,menu,contextmenu,dialogadvtab,div,enterkey,entities,popup,filebrowser,find,fakeobjects,flash,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,iframe,iframedialog,image,indent,indentblock,indentlist,justify,link,list,liststyle,magicline,maximize,pastefromword,pastetext,removeformat,selectall,showblocks,showborders,sourcearea,specialchar,tab,table,tabletools,toolbar,undo,wysiwygarea,lineutils,widget,codesnippet';CKEDITOR.config.skin='moono';(function() {var setIcons = function(icons, strip) {var path = CKEDITOR.getUrl( 'plugins/' + strip );icons = icons.split( ',' );for ( var i = 0; i < icons.length; i++ )CKEDITOR.skin.icons[ icons[ i ] ] = { path: path, offset: -icons[ ++i ], bgsize : icons[ ++i ] };};if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,blockquote,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,bgcolor,312,,textcolor,336,,creatediv,360,,find-rtl,384,,find,408,,replace,432,,flash,456,,horizontalrule,480,,iframe,504,,image,528,,indent-rtl,552,,indent,576,,outdent-rtl,600,,outdent,624,,justifyblock,648,,justifycenter,672,,justifyleft,696,,justifyright,720,,anchor-rtl,744,,anchor,768,,link,792,,unlink,816,,bulletedlist-rtl,840,,bulletedlist,864,,numberedlist-rtl,888,,numberedlist,912,,maximize,936,,pastefromword-rtl,960,,pastefromword,984,,pastetext-rtl,1008,,pastetext,1032,,removeformat,1056,,selectall,1080,,showblocks-rtl,1104,,showblocks,1128,,source-rtl,1152,,source,1176,,specialchar,1200,,table,1224,,redo-rtl,1248,,redo,1272,,undo-rtl,1296,,undo,1320,,codesnippet,1344,','icons_hidpi.png');else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,blockquote,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,bgcolor,312,auto,textcolor,336,auto,creatediv,360,auto,find-rtl,384,auto,find,408,auto,replace,432,auto,flash,456,auto,horizontalrule,480,auto,iframe,504,auto,image,528,auto,indent-rtl,552,auto,indent,576,auto,outdent-rtl,600,auto,outdent,624,auto,justifyblock,648,auto,justifycenter,672,auto,justifyleft,696,auto,justifyright,720,auto,anchor-rtl,744,auto,anchor,768,auto,link,792,auto,unlink,816,auto,bulletedlist-rtl,840,auto,bulletedlist,864,auto,numberedlist-rtl,888,auto,numberedlist,912,auto,maximize,936,auto,pastefromword-rtl,960,auto,pastefromword,984,auto,pastetext-rtl,1008,auto,pastetext,1032,auto,removeformat,1056,auto,selectall,1080,auto,showblocks-rtl,1104,auto,showblocks,1128,auto,source-rtl,1152,auto,source,1176,auto,specialchar,1200,auto,table,1224,auto,redo-rtl,1248,auto,redo,1272,auto,undo-rtl,1296,auto,undo,1320,auto,codesnippet,1344,auto','icons.png');})();CKEDITOR.lang.languages={"de":1,"en":1,"hr":1,"it":1,"sl":1};}());