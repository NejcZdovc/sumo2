...
CKEDITOR.config.removeFormatAttributes="class,style,lang,width,height,align,hspace,valign";(function(){CKEDITOR.plugins.add("selectall",{init:function(b){b.addCommand("selectAll",{modes:{wysiwyg:1,source:1},exec:function(a){var b=a.editable();if(b.is("textarea"))a=b.$,CKEDITOR.env.ie?a.createTextRange().execCommand("SelectAll"):(a.selectionStart=0,a.selectionEnd=a.value.length),a.focus();else{if(b.is("body"))a.document.$.execCommand("SelectAll",!1,null);else{var c=a.createRange();c.selectNodeContents(b);c.select()}a.forceNextSelectionCheck();a.selectionChange()}},canUndo:!1});b.ui.addButton&&
...
CKEDITOR.config.disableNativeSpellChecker=!0;CKEDITOR.config.contentsCss=CKEDITOR.getUrl("contents.css");CKEDITOR.config.plugins='dialogui,dialog,a11yhelp,basicstyles,blockquote,clipboard,lineutils,widget,codesnippet,button,panelbutton,panel,floatpanel,colorbutton,colordialog,menu,contextmenu,dialogadvtab,div,enterkey,entities,popup,filebrowser,find,fakeobjects,flash,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,iframe,iframedialog,image,indent,indentblock,indentlist,justify,link,list,liststyle,magicline,maximize,pastefromword,pastetext,removeformat,selectall,showblocks,showborders,sourcearea,specialchar,tab,table,tabletools,toolbar,undo,wysiwygarea';CKEDITOR.config.skin='moono';(function() {var setIcons = function(icons, strip) {var path = CKEDITOR.getUrl( 'plugins/' + strip );icons = icons.split( ',' );for ( var i = 0; i < icons.length; i++ )CKEDITOR.skin.icons[ icons[ i ] ] = { path: path, offset: -icons[ ++i ], bgsize : icons[ ++i ] };};if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,blockquote,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,codesnippet,312,,bgcolor,336,,textcolor,360,,creatediv,384,,find-rtl,408,,find,432,,replace,456,,flash,480,,horizontalrule,504,,iframe,528,,image,552,,indent-rtl,576,,indent,600,,outdent-rtl,624,,outdent,648,,justifyblock,672,,justifycenter,696,,justifyleft,720,,justifyright,744,,anchor-rtl,768,,anchor,792,,link,816,,unlink,840,,bulletedlist-rtl,864,,bulletedlist,888,,numberedlist-rtl,912,,numberedlist,936,,maximize,960,,pastefromword-rtl,984,,pastefromword,1008,,pastetext-rtl,1032,,pastetext,1056,,removeformat,1080,,selectall,1104,,showblocks-rtl,1128,,showblocks,1152,,source-rtl,1176,,source,1200,,specialchar,1224,,table,1248,,redo-rtl,1272,,redo,1296,,undo-rtl,1320,,undo,1344,','icons_hidpi.png');else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,blockquote,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,codesnippet,312,auto,bgcolor,336,auto,textcolor,360,auto,creatediv,384,auto,find-rtl,408,auto,find,432,auto,replace,456,auto,flash,480,auto,horizontalrule,504,auto,iframe,528,auto,image,552,auto,indent-rtl,576,auto,indent,600,auto,outdent-rtl,624,auto,outdent,648,auto,justifyblock,672,auto,justifycenter,696,auto,justifyleft,720,auto,justifyright,744,auto,anchor-rtl,768,auto,anchor,792,auto,link,816,auto,unlink,840,auto,bulletedlist-rtl,864,auto,bulletedlist,888,auto,numberedlist-rtl,912,auto,numberedlist,936,auto,maximize,960,auto,pastefromword-rtl,984,auto,pastefromword,1008,auto,pastetext-rtl,1032,auto,pastetext,1056,auto,removeformat,1080,auto,selectall,1104,auto,showblocks-rtl,1128,auto,showblocks,1152,auto,source-rtl,1176,auto,source,1200,auto,specialchar,1224,auto,table,1248,auto,redo-rtl,1272,auto,redo,1296,auto,undo-rtl,1320,auto,undo,1344,auto','icons.png');})();CKEDITOR.lang.languages={"de":1,"en":1,"hr":1,"it":1,"sl":1};}());